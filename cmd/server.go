...
var serverCmd = &cobra.Command{
	Use:   "server",
	Short: "HTTP server operations for ffmpeg-serve",
}
...
var startCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		srv, err := server.NewServer(port, gpuID)
		if err != nil {
...
func init() {
	...
	startCmd.Flags().IntP("gpu-id", "g", -1, "GPU device ID to use for hardware acceleration (-1 to disable)")
